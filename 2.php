    ...
    <section id="header">
        ...
        <div>
            <ul id="nav-bar">
              ...
              <li><a href="product.php" class="active" >Products/Gifts</a></li>
              <div class="dropdown">
...
<i id="bar" class="fas fa-outdent"></i>
    ...
    <section id="product1" class="section-p1">
             ...
             <div class="pro-container">
                ...
                //  $sql="SELECT * FROM gift1,product where gift1.p_id=product.p_id";
                $sql = "SELECT  * FROM product where image LIKE 'Gifts%' ORDER BY p_id desc LIMIT 28 ";
